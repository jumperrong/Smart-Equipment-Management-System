    ...
    <el-dialog v-model="dialogVisible" :title="dialogTitle" width="480px">
      <el-form :model="form" :rules="formRules" ref="formRef" label-width="90px">
        ...
        <el-form-item v-if="!form.id" label="密码" prop="password">
          <el-input v-model="form.password" type="password" show-password placeholder="≥3位" />
        </el-form-item>
    ...
    <el-dialog v-model="resetDialogVisible" :title="resetDialogTitle" width="420px">
      <el-form :model="resetForm" :rules="resetRules" ref="resetFormRef" label-width="100px">
        ...
        <el-form-item label="新密码" prop="new_password">
          <el-input v-model="resetForm.new_password" type="password" show-password placeholder="≥3位" />
        </el-form-item>
      </el-form>
      <template #footer>
...
import { listUsers, createUser, updateUser, deleteUser, resetPassword } from '@/api/auth'
...
const roleLabels = { admin: '管理员', engineer: '工程师', process_engineer: '工艺员', operator: '操作员', viewer: '查看者' }
...
const form = reactive({
  id: null, username: '', full_name: '', role: 'operator', password: '', is_active: true,
})
const formRules = {
  ...
  password: [
    {
      validator: (rule, value, cb) => {
        ...
        else if (value && value.length < 3) cb(new Error('密码至少 3 位'))
        else cb()
      },
      trigger: 'blur',
    },
